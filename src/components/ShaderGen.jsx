...
export default function ShaderGen() {
    ...
    const handleGenerate = async () => {
      ...
      glRef.current = null;
        ...
        try {
            const vertexResponse = await axios.post('https://shadergen-api.onrender.com/api/shaders/vertex', {
                prompt: userInput
            }, {
                headers: {
            ...
            const fragmentResponse = await axios.post('https://shadergen-api.onrender.com/api/shaders/fragment', {
